...
Protected (RequireAuth):
  ...
  PUT  /api/leagues/{id}/draft-prep/{gsisId}?season=     — {interest, custom_rank, note, planned_cost}; all-empty deletes the row
       interest = signed scale: +3 must draft, +2 love, +1 like, -1 dislike, -2 hate, -3 do not draft (null = no opinion; 0 rejected)
