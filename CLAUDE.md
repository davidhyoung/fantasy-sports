...
Protected (RequireAuth):
  ...
  PUT  /api/leagues/{id}/draft-prep/{gsisId}?season=     — {interest, custom_rank, custom_tier, note, planned_cost, my_value}; all-empty deletes the row
