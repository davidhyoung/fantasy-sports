...
func main() {
	...
	r.Route("/api/leagues", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Get("/{id}/rosters", h.GetLeagueRosters)
			r.Post("/{id}/rosters", h.AssignLeagueRoster)
			...
			r.Post("/{id}/trades", h.CreateLeagueTrade)
			r.Get("/{id}/transactions", h.ListLeagueTransactions)
			r.Post("/{id}/fa/windows", h.OpenFAWindow)
			r.Get("/{id}/fa/windows", h.ListFAWindows)
			r.Post("/{id}/fa/windows/{windowId}/resolve", h.ResolveFAWindow)
			r.Get("/{id}/fa/offers", h.ListFAOffers)
			r.Post("/{id}/fa/offers", h.CreateOrUpdateFAOffer)
			r.Delete("/{id}/fa/offers/{offerId}", h.WithdrawFAOffer)
			r.Put("/{id}/fa/offers/priority", h.ReorderFAOffers)
			r.Get("/{id}/fa/valuations", h.GetFAValuations)
